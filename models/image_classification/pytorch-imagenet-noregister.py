...
def main():
    ...
    if args.dali:
        ...
        if  args.synergy:
            train_loader = SynergyIterator(train_loader, worker_id=args.local_rank, bs=args.batch_size, steps_this_epoch=int(args.start_index/args.batch_size), epoch=args.start_epoch, dali=args.dali, steps_to_run=1878)
