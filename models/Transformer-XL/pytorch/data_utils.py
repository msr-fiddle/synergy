...
class LMShuffledIterator(object):
    def __init__(self, data, bsz, bptt, device='cpu', ext_len=None, shuffle=False):
        ...
        # Number of mini-batches
        print("# MINIBATCHES = {}".format(len(self.data)))
        self.n_batch = (len(self.data) + self.bptt - 1) // self.bptt
    ...
    def stream_iterator(self, sent_stream):
        ...
        while True:
            ...
            yield data, target, self.bptt, False
...
class LMMultiFileIterator(LMShuffledIterator):
    def __init__(self, paths, vocab, bsz, bptt, device='cpu', ext_len=None,
        ...
        self.device = device
        self.shuffle = shuffle
        print("# MINIBATCHES = {}".format(len(self.paths)))
        self.n_batch = (len(self.paths) + self.bptt - 1) // self.bptt
