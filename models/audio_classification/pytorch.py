...
class DALIGenericIterator(object):
    ...
    def __init__(self,
        ...
        print("GPU = {}".format(self._num_gpus))
    ...
    def __next__(self):
        ...
        for i in range(self._num_gpus):
            ...
            for category, out in category_outputs.items():
                #if category == 'data':
                #    for track in range(len(out)):
                #         print("{} shape = {}".format(track, out.at(track).shape))
        ...
        #self._data_batches[0]["data"] = self._data_batches[0]["data"].unsqueeze(1)
        #print("Size of returned batch {}".format(self._data_batches[0]["data"].size()))
