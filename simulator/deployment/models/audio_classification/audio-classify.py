...
def main():
    ...
    if False and os.path.exists(chk_path):
        ...
        if os.path.isfile(chk_path):
            ...
            print("=> loaded checkpoint '{}' (epoch {}, step {})"
                  .format(chk_path, checkpoint['epoch'], checkpoint['steps_so_far']))
        else:
    ...
    if args.synergy:
        train_loader = SynergyIterator(train_loader, dali=args.dali_cpu, max_iters=args.max_iterations, iters_elapsed=args.steps_so_far)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if args.local_rank == 0:
            ...
            print("Saving checkpoint to {}".format(chk_path))
            save_checkpoint({
                'epoch': epoch + 1,
                'arch': args.arch,
